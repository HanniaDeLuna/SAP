  ...
  namespace uiext {
    ...
    namespace inbox {
      namespace composite {
         ...
         */
        interface $InboxAddAttachmentTileSettings
         ...
         * @deprecated (since 1.120) - the concept has been discarded.
         */
        interface $InboxAttachmentsTileContainerSettings
          extends sap.ui.core.$ControlSettings {
          /**
           ...
           */
          fileType?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
        ...
        interface $InboxAttachmentTileSettings
           ...
           */
          fileSize?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
           ...
           */
          creationDate?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
           ...
           */
          createdBy?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
         ...
         * @deprecated (since 1.120) - the concept has been discarded.
         */
        interface $InboxCommentSettings extends sap.ui.core.$ControlSettings {
          /**
           ...
           */
          sapOrigin?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
        }
         ...
         * @deprecated (since 1.120) - the concept has been discarded.
         */
        interface $InboxTaskCommentsSettings
          extends sap.ui.core.$ControlSettings {
          /**
        ...
        interface $InboxTaskTitleControlSettings
           ...
           */
          taskTitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
         ...
         * @deprecated (since 1.120) - the concept has been discarded.
         */
        interface $InboxUploadAttachmentTileSettings
          extends sap.ui.core.$ControlSettings {
          /**
         ...
         */
        interface InboxAttachmentsTileContainer$UploadButtonPressEventParameters {}

        /**
         * Parameters of the InboxAttachmentsTileContainer#uploadFailed event.
         */
        interface InboxAttachmentsTileContainer$UploadFailedEventParameters {}

        /**
         * Parameters of the InboxAttachmentsTileContainer#uploadSuccess event.
         */
        interface InboxAttachmentsTileContainer$UploadSuccessEventParameters {}

        /**
         * Parameters of the InboxAttachmentTile#deleteAttachment event.
         */
        interface InboxAttachmentTile$DeleteAttachmentEventParameters {}

        /**
         * Parameters of the InboxTaskComments#commentSubmit event.
         */
        interface InboxTaskComments$CommentSubmitEventParameters {}

        /**
         * Parameters of the InboxUploadAttachmentTile#uploadSelectedFile event.
         */
        interface InboxUploadAttachmentTile$UploadSelectedFileEventParameters {}
        ...
        class InboxAddAttachmentTile extends sap.ui.core.Control {
          ...
          constructor(
             ...
             */
            mSettings?: sap.uiext.inbox.composite.$InboxAddAttachmentTileSettings
          );
          /**
           * Constructor for a new composite/InboxAddAttachmentTile.
           *
        ...
        class InboxBusyIndicator extends sap.ui.core.Control {
          ...
          constructor(
             ...
             * initial settings for the new control
             */
            mSettings?: sap.uiext.inbox.composite.$InboxBusyIndicatorSettings
          );
          /**
           * Constructor for a new composite/InboxBusyIndicator.
           *
        ...
        class InboxComment extends sap.ui.core.Control {
          ...
          constructor(
             ...
             * initial settings for the new control
             */
            mSettings?: sap.uiext.inbox.composite.$InboxCommentSettings
          );
          /**
           * Constructor for a new composite/InboxComment.
           *
         ...
         */
        type InboxAttachmentsTileContainer$UploadButtonPressEvent =
          sap.ui.base.Event<
         ...
         */
        type InboxAttachmentsTileContainer$UploadFailedEvent =
          sap.ui.base.Event<
         ...
         */
        type InboxAttachmentsTileContainer$UploadSuccessEvent =
          sap.ui.base.Event<
         ...
         */
        type InboxAttachmentTile$DeleteAttachmentEvent = sap.ui.base.Event<
         ...
         */
        type InboxTaskComments$CommentSubmitEvent = sap.ui.base.Event<
         ...
         */
        type InboxUploadAttachmentTile$UploadSelectedFileEvent =
          sap.ui.base.Event<
       ...
       */
      interface $InboxSettings extends sap.ui.core.$ControlSettings {
        /**
      ...
      interface $InboxLaunchPadSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        logoSrc?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $InboxSplitAppSettings extends sap.ui.core.$ControlSettings {
         ...
         * TCM service URL
         */
        tcmServiceURL?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       */
      interface Inbox$ODataRequestCompletedEventParameters {}

      /**
       * Parameters of the Inbox#refresh event.
       */
      interface Inbox$RefreshEventParameters {}

      /**
       * Parameters of the Inbox#taskAction event.
       */
      interface Inbox$TaskActionEventParameters {}

      /**
       * Parameters of the Inbox#taskSelectionChange event.
       */
      interface Inbox$TaskSelectionChangeEventParameters {}

      /**
       * Parameters of the InboxLaunchPad#logout event.
       */
      interface InboxLaunchPad$LogoutEventParameters {}

      /**
       * Parameters of the InboxLaunchPad#tileSelected event.
       */
      interface InboxLaunchPad$TileSelectedEventParameters {}

      /**
       * Parameters of the InboxSplitApp#navButtonPressed event.
       */
      interface InboxSplitApp$NavButtonPressedEventParameters {}
      ...
      class InboxConfiguration extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.uiext.inbox.InboxConfiguration>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class InboxFilters extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.uiext.inbox.InboxFilters>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class InboxPrimaryFilters extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.uiext.inbox.InboxPrimaryFilters>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class InboxSecondaryFilters extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.uiext.inbox.InboxSecondaryFilters>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
       ...
       */
      type Inbox$ODataRequestCompletedEvent = sap.ui.base.Event<
       ...
       */
      type Inbox$RefreshEvent = sap.ui.base.Event<
        Inbox$RefreshEventParameters,
        Inbox
      >;
       ...
       */
      type Inbox$TaskActionEvent = sap.ui.base.Event<
       ...
       */
      type Inbox$TaskSelectionChangeEvent = sap.ui.base.Event<
       ...
       */
      type InboxLaunchPad$LogoutEvent = sap.ui.base.Event<
       ...
       */
      type InboxLaunchPad$TileSelectedEvent = sap.ui.base.Event<
       ...
       */
      type InboxSplitApp$NavButtonPressedEvent = sap.ui.base.Event<
