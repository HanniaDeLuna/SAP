  ...
  namespace rules {
    ...
    namespace ui {
      namespace services {
         ...
         */
        interface $AstExpressionLanguageSettings
         ...
         */
        interface $ExpressionLanguageSettings
          extends sap.ui.core.$ElementSettings {
          /**
      ...
      class DecisionTableConfiguration extends sap.ui.core.Element {
        ...
        constructor(
           ...
           */
          mSettings?: sap.rules.ui.$DecisionTableConfigurationSettings
        );
        /**
         * Constructor for a new DecisionTableConfiguration.
         *
      ...
      class RuleBuilder extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * Initial settings for the new control.
           */
          mSettings?: sap.rules.ui.$RuleBuilderSettings
        );
        /**
         * Constructor for a new RuleBuilder control.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.rules.ui.RuleBuilder>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
         ...
         * or `null`.
         */
        getAstExpressionLanguage(): sap.ui.core.ID | null;
        /**
         * Gets current value of property {@link #getBindingContextPath bindingContextPath}.
         *
         * Path to a Rule object in the model data, which is used for the definition of relative context bindings
         ...
         * @deprecated (since 1.120.2) - use the attribute astExpressionLanguage instead.
         */
        getExpressionLanguage(): sap.ui.core.ID | null;
        /**
      ...
      class TextRuleConfiguration extends sap.ui.core.Element {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.rules.ui.$TextRuleConfigurationSettings
        );
        /**
         * Constructor for a new TextRuleConfiguration.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.rules.ui.TextRuleConfiguration>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
