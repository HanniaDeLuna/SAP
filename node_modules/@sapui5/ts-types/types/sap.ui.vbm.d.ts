  ...
  namespace ui {
    ...
    namespace vbm {
      ...
      interface $ListPanelSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        headerIconPress?: (oEvent: sap.ui.base.Event) => void;
      ...
      class Adapter3D extends sap.ui.core.Element {
         ...
         */
        getViewport(): sap.ui.core.ID | null;
        /**
      ...
      class ContainerBase extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.ui.vbm.$ContainerBaseSettings
        );
        /**
         * Abstract Constructor for a new Container.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.vbm.ContainerBase>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
        ...
        addContent(
           ...
           */
          oObject: sap.ui.vbm.ContainerContent
        ): void;
        /**
        ...
        fireContentChange(
           ...
           * Parameters to pass along with the event
           */
          mParameters?: sap.ui.vbm.ContainerBase$ContentChangeEventParameters
        ): this;
        /**
         ...
         * Content Aggregation.
         */
        getContent(): sap.ui.vbm.ContainerContent[];
        /**
         ...
         */
        getSelectedContent(): sap.ui.vbm.ContainerContent;
        /**
        ...
        indexOfContent(
           ...
           */
          oContent: sap.ui.vbm.ContainerContent
        ): int;
        /**
         ...
         * @returns An array of the removed elements (might be empty)
         */
        removeAllContent(): sap.ui.vbm.ContainerContent[];
        /**
        ...
        removeContent(
           ...
           */
          vContent: int | string | sap.ui.vbm.ContainerContent
        ): sap.ui.vbm.ContainerContent | null;
        /**
      ...
      class ContainerContent extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.ui.vbm.$ContainerContentSettings
        );
        /**
         * Constructor for a new ContainerContent.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.vbm.ContainerContent>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
        ...
        extends /* was: sap.m.StandardListItem */ Object
      {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.vbm.ContainerLegendItem>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class ListPanel extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.ui.vbm.$ListPanelSettings
        );
        /**
         * Constructor for a new ListPanel.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.vbm.ListPanel>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
        ...
        fireItemPress(
           ...
           * Parameters to pass along with the event
           */
          mParameters?: sap.ui.vbm.ListPanel$ItemPressEventParameters
        ): this;
        /**
        ...
        fireSelectionChange(
           ...
           * Parameters to pass along with the event
           */
          mParameters?: sap.ui.vbm.ListPanel$SelectionChangeEventParameters
        ): this;
        /**
      ...
      class ListPanelStack extends sap.ui.core.Control {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.ui.vbm.$ListPanelStackSettings
        );
        /**
         * Constructor for a new ListPanelStack.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.vbm.ListPanelStack>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
         ...
         * Gets content of aggregation {@link #getContent content}.
         */
        getContent(): sap.ui.vbm.ListPanel[];
        /**
         * Gets current value of property {@link #getExpandAnimation expandAnimation}.
         *
         * Expand animation
         ...
         * @returns An array of the removed elements (might be empty)
         */
        removeAllContent(): sap.ui.vbm.ListPanel[];
        /**
         * Removes a content from the aggregation {@link #getContent content}.
         *
         *
        ...
        removeContent(
           ...
           * The content to remove or its index or id
           */
          vContent: int | string | sap.ui.vbm.ListPanel
        ): sap.ui.vbm.ListPanel | null;
        /**
       ...
       * Abstract Constructor for a new Container.
       */
      class MapContainer extends sap.ui.vbm.ContainerBase {
        /**
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.ui.vbm.$MapContainerSettings
        );
        /**
         * Constructor for a new MapContainer.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.vbm.MapContainer>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
       ...
       */
      abstract class VoAbstract extends sap.ui.core.Element {
        /**
       ...
       */
      abstract class VoAggregation extends sap.ui.vbm.VoAbstract {
        /**
