...
declare namespace sap {
  ...
  namespace makit {
    ...
    interface $CategorySettings extends sap.ui.core.$ElementSettings {
       ...
       */
      column?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

      /**
       * The text label representing this Category(on value bubble or table's header)
       */
      displayName?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       */
      format?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    }
    ...
    interface $ChartSettings extends sap.ui.core.$ControlSettings {
       ...
       */
      doubletap?: (oEvent: sap.ui.base.Event) => void;

      /**
       * Single tap event on the chart
       */
      tap?: (oEvent: sap.ui.base.Event) => void;

      /**
       * Long press event on the chart
       */
      longpress?: (oEvent: sap.ui.base.Event) => void;
    }
    ...
    interface $ValueSettings extends sap.ui.core.$ElementSettings {
       ...
       */
      expression?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       */
      locale?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    }
    ...
    interface $ValueAxisSettings extends sap.makit.$AxisSettings {
       ...
       */
      min?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

      /**
       * Highest displayed value on the Value Axis (this value will be automatically adjusted to nearest major
       * tick value depending on the value's range)
       */
      max?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    }
    ...
    class Axis extends sap.ui.core.Element {
      ...
      constructor(
         ...
         */
        mSettings?: sap.makit.$AxisSettings
      );
      /**
       * Constructor for a new Axis.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Axis>,
        /**
    ...
    class Category extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$CategorySettings
      );
      /**
       * Constructor for a new Category.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Category>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class CategoryAxis extends sap.makit.Axis {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$CategoryAxisSettings
      );
      /**
       * Constructor for a new CategoryAxis.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.CategoryAxis>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Chart extends sap.ui.core.Control {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$ChartSettings
      );
      /**
       * Constructor for a new Chart.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Chart>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Column extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$ColumnSettings
      );
      /**
       * Constructor for a new Column.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Column>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class CombinationChart extends sap.ui.core.Control {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$CombinationChartSettings
      );
      /**
       * Constructor for a new CombinationChart.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.CombinationChart>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Layer extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$LayerSettings
      );
      /**
       * Constructor for a new Layer.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Layer>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class MakitLib extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$MakitLibSettings
      );
      /**
       * Constructor for a new MakitLib.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.MakitLib>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Row extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$RowSettings
      );
      /**
       * Constructor for a new Row.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Row>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Series extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$SeriesSettings
      );
      /**
       * Constructor for a new Series.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Series>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class Value extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$ValueSettings
      );
      /**
       * Constructor for a new Value.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.Value>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class ValueAxis extends sap.makit.Axis {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$ValueAxisSettings
      );
      /**
       * Constructor for a new ValueAxis.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.ValueAxis>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class ValueBubble extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.makit.$ValueBubbleSettings
      );
      /**
       * Constructor for a new ValueBubble.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.makit.ValueBubble>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
