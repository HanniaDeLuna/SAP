  ...
  namespace chart {
    ...
    namespace data {
      ...
      class Dimension extends sap.ui.core.Element {
        ...
        constructor(
           ...
           */
          mSettings?: sap.chart.data.$DimensionSettings
        );
        /**
         * Constructor for a new ui5/data/Dimension.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           */
          oClassInfo?: sap.ClassInfo<T, sap.chart.data.Dimension>,
          /**
      ...
      class HierarchyDimension extends sap.chart.data.Dimension {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.chart.data.$HierarchyDimensionSettings
        );
        /**
         * Constructor for a new ui5/data/HierarchyDimension.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.chart.data.HierarchyDimension>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class Measure extends sap.ui.core.Element {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.chart.data.$MeasureSettings
        );
        /**
         * Constructor for a new ui5/data/Measure.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.chart.data.Measure>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class TimeDimension extends sap.chart.data.Dimension {
        ...
        constructor(
           ...
           * initial settings for the new control
           */
          mSettings?: sap.chart.data.$TimeDimensionSettings
        );
        /**
         * Constructor for a new ui5/data/TimeDimension.
         *
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.chart.data.TimeDimension>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
    ...
    class Chart extends sap.viz.ui5.controls.common.BaseControl {
      ...
      constructor(
         ...
         * initial settings for the new control
         */
        mSettings?: sap.chart.$ChartSettings
      );
      /**
       * Constructor for a new Chart.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.chart.Chart>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
      ...
      removeDimension(
         ...
         */
        oDimension: int | string | sap.chart.data.Dimension
      ): sap.chart.data.Dimension;
      /**
